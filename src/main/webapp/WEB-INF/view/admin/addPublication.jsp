            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="loginForm" method="POST"
                          action="${pageContext.request.contextPath}/admin/addPublication">
                        <fieldset>
                            <div class="form-group">
                                <label for="title_en"><fmt:message key="title_en"/></label>
                                <input class="form-control" value="${param.title_en}" name="title_en" id="title_en"
                                       type="text" required>
                                <p class="text-danger">
                                        ${wrongtitle_en}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title_ua" value="${param.title_ua}" name="title_ua"
                                       type="text" required>
                                <p class="text-danger">
                                        ${wrongtitle_ua}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="${param.author}" name="author" id="author"
                                       type="text" required>
                                <p class="text-danger">
                                        ${wrongauthor}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="${param.genre_en}" name="genre_en" id="genre_en"
                                       type="text" required>
                                <p class="text-danger">
                                        ${wronggenre_en}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="${param.genre_ua}" name="genre_ua" id="genre_ua"
                                       type="text" required>
                                <p class="text-danger">
                                        ${wronggenre_ua}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="${param.price}" name="price" id="price" type="number"
                                       step=".01" required>
                                <p class="text-danger">
                                        ${wrongprice}
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" class="form-control" rows="5" name="description_en"
                                          id="description_en" required>${param.description_en}</textarea>
                                <p class="text-danger">
                                        ${wrongdescription_en}
                                </p>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" class="form-control" rows="5" name="description_ua"
                                          id="description_ua" required>${param.description_ua}</textarea>
                                <p class="text-danger">
                                        ${wrongdescription_ua}
                                </p>
                            </div>
                            <input class="btn btn-lg btn-success btn-block" type="submit"
                                   value="<fmt:message key="add.publication"/>"/>
                        </fieldset>
                    </form>
                </div>
            </div>
